...
typedef TTriple<TInt64, TInt64, TInt64> TInt64Tr;
...
typedef TTriple<TInt64, TStr, TStr> TInt64StrStrTr;
...
typedef TVec<TInt64StrStrTr, int64> TIntStrStrTr64V;
typedef TVec<TIntKd> TIntKdV;
...
typedef TVec<TStrPr, int64> TStrPr64V;
...
typedef TVec<TStrTr, int64> TStrTr64V;
