...
PNGraph CascGraph(PTable P,const TStr C1,const TStr C2,const TStr C3,const TStr C4,const TInt64 W,bool SortParam = true);
/// Takes as input a directed graph and returns all the top cascades in \c TopCascVV.
void CascFind(PNGraph Graph,PTable P,const TStr C1,const TStr C2,const TStr C3,const TStr C4,TVec<TInt64V, int64> &TopCascVV,bool Print = false);
